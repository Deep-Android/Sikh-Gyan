...
public class Youtube3 extends YouTubeBaseActivity implements
		YouTubePlayer.OnInitializedListener {
	static private final String DEVELOPER_KEY = "AIzaSyAtqdhiy9NVwbw1rEN5DKRS5m7NK6ziO70";
	static private final String VIDEO = "NmVs6DG1ubI";
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		Intent activityIntent = new Intent(Youtube3.this,
				YoutubeList.class);
		Youtube3.this.startActivity(activityIntent);
		finish();
	}
}
