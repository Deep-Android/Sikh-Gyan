...
public class Youtube4 extends YouTubeBaseActivity implements
		YouTubePlayer.OnInitializedListener {
	static private final String DEVELOPER_KEY = "AIzaSyAtqdhiy9NVwbw1rEN5DKRS5m7NK6ziO70";
	static private final String VIDEO = "TPtMgnKinfc";
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		Intent activityIntent = new Intent(Youtube4.this,
				YoutubeList.class);
		Youtube4.this.startActivity(activityIntent);
		finish();
	}
}
